...
int main()
{
	...
	double *w1 = w;
	Branchbound a;
	double clocksPerMillis = double(CLOCKS_PER_SEC) / 100000;
	clock_t startTime = clock();
	std::cout << "程序最优值为：" <<
		a.answer({ 560,1125,300,620,2100,431,68,328,47,122,322,196,41,25,425,4260,416,115,82,22,631,132,420,86,42,103,215,81,91,26,49,420,316,72,71,49,108,116,90,738,1811,430,3060,215,58,296,620,418,47,81 },
			{ 800,650,550,550,650 },
			50,
	...
	double aaaaa = (clock() - startTime) / clocksPerMillis;
	std::cout << "程序用时：" << aaaaa / (double)60000 << "s" << std::endl;
	std::system("pause");
	return 0;
}
